...
using Sqloom.TestApp.Entities;

namespace Sqloom.TestApp;

public partial class TestAppProductCatalogDbContext : DbContext
{
    public TestAppProductCatalogDbContext(DbContextOptions<TestAppProductCatalogDbContext> options)
        : base(options)
    {
    }
