...
internal sealed class HostConsoleWriter
{
    ...
    public void PrintUsage()
    {
        ...
        Console.WriteLine("    When omitted, --artifact-dir defaults to backend/artifacts/sqloom/tune/tune-<timestamp>. With tune, --artifact-dir means the workflow root, not a replay-only directory.");
        Console.WriteLine(
