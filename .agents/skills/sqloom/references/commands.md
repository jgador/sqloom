...
Generated from `src/Sqloom.Host/CommandCatalog.cs`. This is the canonical Sqloom CLI reference for coding agents and repo docs. Do not edit this file directly.
...
- When validating an installed tool, run `sqloom help <command>` and compare the command surface against this generated reference.
...
| Command | Description |
| --- | --- |
| `init` | Scaffolds the embedded sqloom agent skill from a Git repository root. |
