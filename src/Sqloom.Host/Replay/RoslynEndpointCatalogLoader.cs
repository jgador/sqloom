...
/// <summary>
/// Discovers replayable MVC controller endpoints from ASP.NET Core project source.
/// </summary>
internal sealed partial class RoslynEndpointCatalogLoader : IReplayOperationCatalogLoader
{
