...
public static class CommandReferenceMarkdown
{
    ...
    public static string Render()
    {
        ...
        builder.AppendLine();
        builder.AppendLine("Generated from `src/Sqloom.Host/CommandCatalog.cs`. This is the canonical Sqloom CLI reference for coding agents and repo docs. Do not edit this file directly.");
        builder.AppendLine();
        ...
        builder.AppendLine("- When validating an installed tool, run `sqloom help <command>` and compare the command surface against this generated reference.");
        builder.AppendLine();
